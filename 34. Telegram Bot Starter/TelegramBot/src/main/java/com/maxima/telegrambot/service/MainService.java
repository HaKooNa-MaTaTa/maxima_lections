package com.maxima.telegrambot.service;

import com.maxima.telegrambot.config.TelegramProperties;
import com.maxima.telegrambot.model.StatusProject;
...
public class MainService extends TelegramLongPollingBot {
    ...
    @Autowired
    public MainService(TelegramProperties properties) {
